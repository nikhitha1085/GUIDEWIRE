...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row relative overflow-hidden selection:bg-indigo-500/20 font-sans text-slate-800">
      ...
      {/* Main Content Area */}
      <main className="flex-1 overflow-y-auto relative z-10 pb-24 md:pb-0 scroll-smooth flex flex-col">
        <NavBar />
        <WeatherAlerts />
        {!isAuthenticated && (
          <div className="relative z-30 bg-indigo-50/80 backdrop-blur-3xl border-b border-indigo-200/50 py-3 px-6 flex items-center justify-center gap-3 text-indigo-800 text-sm font-bold tracking-wide w-full shadow-sm">
